...
const Navbar = () => {
  ...
  return (
    <div className='max-w-screen-xl mx-auto p-4 '>
      <nav className="flex h-9 items-center justify-between" aria-label="Global">
        ...
        <div className='flex'>
          <div className="flex lg:hidden ">
            {!isPayment && <button type="button" onClick={handleNav}
          ...
          {
            !isPayment && <div className="hidden lg:flex lg:min-w-0 lg:flex-1 lg:gap-x-1">
              ...
              <Link to="about" spy={true} smooth={true} offset={-80} duration={500}
                    className="font-semibold text-gray-900 hover:text-gray-900 hover:bg-zinc-200 py-2 px-4 rounded-md cursor-pointer">About
                us</Link>
      ...
      {/* {sideNav && */}
      {
        !isPayment && <div className={sideNav ? ' ease-in-out duration-100' : 'hidden'}>
              ...
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6">
                  ...
                  <Link to="blogs" spy={true} smooth={true} offset={-80} duration={500}
                        className="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-300"
                        onClick={handleNav}>Products</Link>
                </div>
                {/*<div className="py-6">*/}
                {/*  <Link to="demo" spy={true} smooth={true} offset={-80} duration={500}*/}
                {/*        className="inline-block rounded-lg px-5 py-2 text-sm font-semibold leading-6 text-gray-900 shadow-sm ring-1 ring-gray-900/10 hover:ring-gray-900/20 cursor-pointer">Log*/}
                {/*    in</Link>*/}
                {/*</div>*/}
              </div>
            </div>
